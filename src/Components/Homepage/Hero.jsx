        ...
        >
            <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <div>
                    ...
                    <h2 className="text-5xl sm:text-6xl md:text-7xl font-bold text-[#f7fff7] font-serif leading-tight drop-shadow-lg">
                        Find Your Next <span className="italic font-light text-violet-300">Read</span>
                    </h2>
                </div>
                <p className="max-w-2xl mx-auto text-lg sm:text-xl text-[#f7fff7]/90 font-light leading-relaxed">
